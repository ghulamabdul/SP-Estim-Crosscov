...
#####################################################################
setwd("/ibex/scratch/qadirga/Simulation_Studies_Old/Bumped_coherence_function")
...
###### Plotting few realizations #########
par(mfrow=c(1,1))
par(cex.axis=2, cex.lab=3, cex.main=1, cex.sub=1,mar=c(4,4,1,2)+.1)
...
optim.pars<-foreach(i=1:100) %dopar%
{
  ...
  tr.sp<-c(0.4, 0.4,  0.4, 0.4,  0.4, 0.4,  0.4, 0.4)
  ...
  init.2<-c(0.7,0.7,0.9,0.9,tr.sp) #initial values
...
save.image("Fullanalysisbm.RData")
